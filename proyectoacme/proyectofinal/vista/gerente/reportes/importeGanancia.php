...
<html lang="en">
    <head>
        ...
        <title>Importes de ganancia</title>
                  ...
                  <div class="tab-content" id="nav-tabContent">
                    ...
                    <main class="centrar-main">
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">Importe de ganancia por semana</h1><br>
                        </div>
                    </main>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <main class="centrar-main">
                            <div class="container-fluid px-4">
                                <h1 class="mt-4">Importe por de ganancia por quincena</h1><br>
                            </div>
                        </main>
                    ...
                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                        <main class="centrar-main">
                            <div class="container-fluid px-4">
                                <h1 class="mt-4">Importe de ganacia por mes</h1><br>
                            </div>
                        </main>
    ...
    <script>
        ...
        // Las etiquetas son las que van en el eje X. 
        const etiquetasMensuales = ["Enero", "Febrero", "Marzo", "Abril","Mayo"]
        // Podemos tener varios conjuntos de datos. Comencemos con uno
